...
def handle_turn():
    ...
    while not valid:
        while position not in ["1","2","3","4","5","6","7","8","9"
                                                               ""]:
            position = input("Choose a positionfrom 0 to 8:")
        #print(board[position]==current_player)
    ...
    if position<8:
        while position not in["0","1","2","3","4","5","6","7","8"]:
            ...
            if position>8:        
                position = int(input("Choose a random position from 0 to 8:"))"'''
    '''elif position==board[position]:
        print("Value already exist in this position please enter any other position")'''
